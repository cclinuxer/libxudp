...
ip link set veth-br1 down
ip link set veth-br2 down
ip -n ns1 link set veth-ns1 down
ip -n ns2 link set veth-ns2 down
ip link set virtual-bridge down

brctl delif virtual-bridge veth-br2
brctl delif virtual-bridge veth-br2

ip -n ns2 link del veth-ns2 
ip link del veth-br1
ip -n ns1 link del veth-ns1 
ip link del veth-br2

rmmod veth
#insmod /mnt/nfs/bare_metal_kernel/byteatom-kernel/drivers/net/veth.ko
insmod /mnt/nfs/bare_metal_kernel/af_xdp_5_10_bsk/linux-image-bsk/linux-image-bsk/drivers/net/veth.ko
